const simonMenu = document.querySelector("#simonMenu");

//Event listener
simonMenu.addEventListener("click", removePlayer);
simonMenu.addEventListener("input", focusNameField);
...
function addPlayer() {
	...
	simonMenu.appendChild(newPlayerLi);
}
...
function isAllNameValid() {
	const allNameInput = document.querySelectorAll("#simonMenu li input");
	var nameValid = true;
	var nbName;
